        ...
        <div>
            <div className="flex justify-right items-center h-screen relative">
                ...
                <div className="relative bg-white w-1/2 h-full text-black overflow-hidden">
                    <div className="bg-cuponBlue w-8/12 h-full text-black overflow-hidden relative">
                        <img src="/assets/CuponesFondo.png" className="w-full h-full object-cover transform scale-125" />
                        <div className="absolute inset-0 flex justify-center items-center">
                            <div className="bg-cuponBlue w-80 h-52 flex flex-col justify-center items-center rounded-xl font-poppins md:font-semibold text-white text-3xl p-2 z-10">
                                Sos miembro?
                                <div className="text-lg mt-2 text-center font-poppins md:font-normal">
                                    Registrate para empezar a ofrecer cupones
                                </div>
                                <NavLink to="/registroCuponero" className={({ isActive }) => (isActive ? activeLink : btnLink)}>
            ...
            <div className="absolute right-[148px] top-64 z-0 flex h-32 w-[634px] flex-shrink-0 items-center justify-center text-center text-3xl leading-[44px] tracking-normal">
                <div className='font-poppins pr-[44spx] text-center text-2xl leading-[44px] tracking-normal text-black'>
                    Ingresa para ofrecer los mejores cupones a cientos de usuarios
                </div>
            </div>
            <div className="absolute right-[130px] top-44 z-0 flex h-32 w-[639px] flex-shrink-0 items-center justify-center text-center text-3xl leading-[44px] tracking-normal">
