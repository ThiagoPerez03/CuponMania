...
export default function RegistroCuponManiaco() {
        ...
        <div>
            <form onSubmit={handleSubmit}>
                <div className="flex justify-left items-center h-screen relative">
                    ...
                    <div className="absolute left-[182px] top-64 z-0 flex h-32 w-[634px] flex-shrink-0 items-center justify-center text-center text-3xl leading-[44px] tracking-normal">
                        <div className='font-poppins pr-[44px] text-center text-2xl leading-[44px] tracking-normal text-black'>
                            Registrate para empezar a obtener los mejores cupones en cientos de lugares
                        </div>
                    </div>
                    <div className="absolute left-[178px] top-44 z-0 flex h-32 w-[639px] flex-shrink-0 items-center justify-center text-center text-3xl leading-[44px] tracking-normal">
                        <div className="font-sans pr-[44px] text-right text-4xl font-black leading-[44px] tracking-normal text-black ">
                            Crear una cuenta nueva
                        </div>
                    </div>
                    <div className="relative bg-cuponRed w-[500px] h-full text-black overflow-hidden">
                        <img src="/assets/CuponesFondo.png" className="w-full h-full object-cover transform scale-125" />
                        <div className="absolute inset-0 flex justify-center items-center">
                            <div className="bg-cuponRed w-80 h-52 flex flex-col justify-center items-center rounded-xl font-poppins md:font-semibold text-white text-2xl p-2 z-10">
                                Bienvenido de Vuelta
                                <div className="text-lg mt-2 text-center font-poppins md:font-normal">
                                    Para empezar a obtener cupones Inicia Sesion
                                </div>
